...
export interface AdMobNativeAdvancedPlugin {
     ...
     * @since 1.0.0
     */
    addListener(eventName: NativeAdEventName, listenerFunc: (data: NativeAdEvent) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    /**
...
export type AdPosition = "TOP_LEFT" | "TOP_CENTER" | "TOP_RIGHT" | "BOTTOM_LEFT" | "BOTTOM_CENTER" | "BOTTOM_RIGHT" | "CENTER" | "CUSTOM";
export type NativeAdTemplate = "SMALL" | "MEDIUM" | "LARGE";
export type NativeAdEventName = "onAdLoaded" | "onAdFailedToLoad" | "onAdImpression" | "onAdClicked" | "onAdOpened" | "onAdClosed";
